    ...
    AROUND_BORDER(){
        ...
        public Border getBorder(AbstractInventory abstractInventory,boolean ignoreComponents,ItemStack material,int parameter) {
            ...
            for (int i = 1; i < lines; i++) {
               if ((i-1)*9==0)continue;
               deploySlots = CommonUtil.addIntegerElements(deploySlots,(i-1)*9);
               deploySlots = CommonUtil.addIntegerElements(deploySlots,(i*9)-1);
            }
            deploySlots = CommonUtil.addIntegerElements(deploySlots,CommonUtil.getIntArrayFromAToB((lines-1)*9, parameter -1));
    ...
    VERTICAL_BORDER(){
        ...
        public Border getBorder(AbstractInventory abstractInventory, boolean ignoreComponents, ItemStack material, int parameter) {
            ...
            for (int i = 0; i < lines; i++) {
                deploySlots = CommonUtil.addIntegerElements(deploySlots,(parameter-1)+9);
            }
